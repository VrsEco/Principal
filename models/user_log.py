...
class UserLog(db.Model):
    ...
    user_email = db.Column(db.String(120), nullable=False)  # Store email for historical reference
    user_name = db.Column(db.String(100), nullable=False)  # Store name for historical reference
    
    # Operation details
    action = db.Column(db.String(50), nullable=False)  # CREATE, UPDATE, DELETE, LOGIN, LOGOUT, VIEW
    entity_type = db.Column(db.String(50), nullable=False)  # company, plan, participant, etc.
