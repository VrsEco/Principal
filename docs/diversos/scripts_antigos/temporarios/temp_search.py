...
paths = [
    Path(
        r"C:/GestaoVersus/Referencias/recuperacao_28out/dados_docker_28out/base/16384"
    ),
    Path(
        r"C:/GestaoVersus/Referencias/recuperacao_28out/dados_docker_28out/base/16389"
    ),
]
for base in paths:
