...
endpoints = [
    ...
    ('GET', f'/api/companies/{company_id}/employees/{employee_id}', None, 'Employee detail (GET)'),
    ('GET', f'/api/companies/{company_id}/mvv', None, 'Company MVV'),
    ('GET', f'/api/companies/{company_id}/routine-tasks/overdue', None, 'Routine overdue'),
    ('GET', f'/api/companies/{company_id}/routine-tasks/upcoming', None, 'Routine upcoming'),
