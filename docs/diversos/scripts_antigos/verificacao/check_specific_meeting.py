    ...
    try:
        ...
        if meeting:
                    ...
                    try:
                        ...
                        if field == 'guests_json':
                            ...
                            for guest in internal:
                                print(f"    - {guest.get('name', 'Sem nome')} (ID: {guest.get('id')})")
                            ...
                            for act in parsed:
                                ...
                                print(f"      Responsavel: {act.get('responsible', 'Nao definido')}")
                                print(f"      Prazo: {act.get('deadline', 'Sem prazo')}")
            ...
            if similar:
                ...
                for row in similar:
                    row_dict = dict(row)
                    print(f"  ID {row_dict['id']}: {row_dict['title']} - {row_dict['scheduled_date']}")
