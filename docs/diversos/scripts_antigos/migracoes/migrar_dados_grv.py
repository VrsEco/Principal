...
def migrar_grv():
    ...
    print(
        f"  TOTAL:               {areas_origem + macros_origem + procs_origem + acts_origem}"
    )
    ...
    print(
        f"  TOTAL:               {areas_final + macros_final + procs_final + acts_final}"
    )
    ...
    print("\n" + "=" * 80)
    if (
        areas_final == areas_origem
        and macros_final == macros_origem
        and procs_final == procs_origem
    ):
