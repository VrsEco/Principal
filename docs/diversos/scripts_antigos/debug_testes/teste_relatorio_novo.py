...
def test_new_report():
    ...
    try:
        ...
        alteracoes = {
            ...
            "Campo 'Processo | Responsável'": "Processo:" in html
            and "Responsável:" in html,
            "Campo 'Macroprocesso | Dono'": "Macroprocesso:" in html
            and "Dono:" in html,
            "Campo 'Nº de Páginas'": "Nº de Páginas:" in html
            or "páginas" in html.lower(),
        }
