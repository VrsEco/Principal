...
COMPANY_ID = 1
MANIFEST_PATH = Path('tmp/save_water_import_manifest_atraso_30042026_v1.json')
REPORT_PATH = Path('tmp/save_water_canonical_reprocess_atraso_30042026_v1.json')
SOURCE_FILE = 'Conta Azul - Versus - Final Pagar em Atrazo ate 30042026.xls'
SCHEDULE_BATCH_ID = 'conta_azul_save_water_canonical_schedule_atraso_30042026_v1'
AGENT_NAME = 'codex'
...
def _ensure_counterparty_id(cache: Dict[str, Any], name: str, document: str) -> Optional[int]:
    ...
    cp = FinancialCounterparty(
        ...
        notes='Criado automaticamente na migração Conta Azul atraso 30042026',
        is_active=True,
        metadata_json={
