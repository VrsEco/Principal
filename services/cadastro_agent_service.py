...
class CadastroAgentService:
    ...
    def analisar_completude(self, company_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            # Buscar dados de planos (CompanyData)
            ...
            # Calcular percentual
            percentual = self._calcular_percentual_completude(company, company_data_list)
    ...
    def _validar_completude(self, company: Company, company_data_list: List[CompanyData]) -> Dict[str, Any]:
    ...
    def _calcular_percentual_completude(self, company: Company, company_data_list: List[CompanyData]) -> int:
