...
def test_route_audit_get_routes_without_logging(base_url, timeout):
    ...
    try:
        ...
        pytest.fail(
            f"Erro na requisição GET /route-audit/api/routes/without-logging: {e}"
        )
...
def test_route_audit_get_route_details(base_url, timeout):
    ...
    try:
        ...
        pytest.fail(
            f"Erro na requisição GET /route-audit/api/routes/<path:endpoint>/details: {e}"
        )
...
def test_route_audit_enable_entity_logging(base_url, timeout):
    ...
    try:
        ...
        pytest.fail(
            f"Erro na requisição POST /route-audit/api/entity/<entity_type>/enable: {e}"
        )
...
def test_route_audit_disable_entity_logging(base_url, timeout):
    ...
    try:
        ...
        pytest.fail(
            f"Erro na requisição POST /route-audit/api/entity/<entity_type>/disable: {e}"
        )
