"""
Constantes compartilhadas entre os testes do GestaoVersus.
"""
...
KNOWN_SERVER_GAPS = {
    ...
    "/api/reports/preview",
    "/plans/<plan_id>/alignment-records/<alignment_id>",
    "/plans/<plan_id>/directional-records/<directional_id>",
    "/plans/<plan_id>/interviews/<interview_id>",
    "/plans/<plan_id>/market-records/<market_id>",
    ...
    "/plans/<plan_id>/vision-records/<vision_id>",
    "/plans/<plan_id>/misalignment-records/<misalignment_id>",
