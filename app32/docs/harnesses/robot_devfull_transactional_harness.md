...
| Processes/BPMN | Lista, detalhe, modeler, diagrama, save de rascunho | Falta ciclo criar processo -> instanciar -> executar -> cancelar/excluir | criar, versionar, publicar/rascunhar, instanciar, executar | remover instâncias/rascunhos/processo teste | Pendente transacional |
