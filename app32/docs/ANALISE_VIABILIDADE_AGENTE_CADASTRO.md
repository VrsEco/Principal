...
**Localização:** `services/cadastro_agent_service.py`
...
- Arquitetura baseada em OpenAI API + GPT-4o
...
| Integração com OpenAI complexa | Baixa | Alto | Usar BaseAgent existente, seguir padrão |
...
- **GPT-4o:**
  ...
  - Estimativa: 100K tokens/mês = ~$1.25/mês
