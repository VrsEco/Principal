...
5. modelar com `versus-modelagem-processos-bpmn`;
6. validar o arquivo:
...
7. importar e revisar visualmente no modelador APP32;
8. apresentar diferenças, POPs seletivos, rotina e indicadores mínimos;
9. gravar rascunho somente após autorização e reler;
10. publicar somente após confirmação humana explícita.
