...
@media print {
  ...
  /* Ocultar elementos de UI do sistema (Gold Rule @FRONTEND) */
  .no-print, .workspace-navbar, .workspace-sidebar, .workspace-sidebar-right, 
  .navbar-actions, .app-header, .btn, .user-pill, #ui-ref-toggle {
