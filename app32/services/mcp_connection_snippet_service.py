    ...
    def build_prompt(cls, payload: dict[str, Any]) -> str:
        ...
        lines.extend(
            [
                ...
                "6.3. Se o payload resolvido trouxer `activation_welcome_opening`, use essa mensagem como resposta inicial da sessão.",
                "6.4. Se o usuário pedir instruções, mostre `activation_welcome_short`.",
                "6.5. Se depois o usuário pedir mais detalhes, mostre `activation_welcome_full`.",
