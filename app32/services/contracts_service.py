...
class ContractService:
    ...
    def build_contract_fiscal_snapshot(contract: Contract, reference_date: Optional[date] = None) -> dict:
        ...
        return {
            ...
            "service_state": fiscal_metadata.get("service_state") or (legal_entity.uf if legal_entity and resolved_service_city == legal_entity.service_city else None),
            "service_city_code_ibge": fiscal_metadata.get("service_city_code_ibge")
            or (legal_entity.city_code_ibge if legal_entity and resolved_service_city == legal_entity.service_city else None),
