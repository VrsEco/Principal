...
class ToolFirstCatalogService:
    ...
    DOMAIN_SPECS = (
        ...
        {
            "key": "real_estate_auctions",
            "title": "Leilões Imobiliários",
            "status": "canonical",
            "description": "Pipeline multi-tenant de oportunidades imobiliárias, fontes, eventos, ficha financeira e diligência.",
            "legacy_routes": [],
            "canonical_routes": ["/real-estate-auctions"],
            "entrypoint": "/real-estate-auctions",
            "surface": "sapiens",
            "rest_contracts": [
                {"name": "open_real_estate_auction_workspace", "method": "GET", "path": "/real-estate-auctions", "status": "ready"},
            ],
            "mcp_contracts": [
                {"name": "list_app32_capabilities", "status": "ready", "notes": "Discovery do domínio real_estate_auctions."},
            ],
            "tool_names": (
            ...
            "planned_tools": ("import_real_estate_auction_source_batch", "rank_real_estate_auction_opportunities"),
            "governance": [
                "Todas as leituras e mutações são escopadas por company_id e respeitam habilitação do módulo no tenant.",
                "Arquivamentos, fontes e ficha financeira exigem auditoria e política de menor privilégio.",
            ],
        },
        {
            "key": "work_journey",
