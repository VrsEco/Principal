...
Sem autorização explícita, não faça commit, push, merge, deploy, escrita em produção ou mutação administrativa sensível. Se disponível, defina o título como `SV - [título da tarefa]`.
