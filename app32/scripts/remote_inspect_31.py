...
def run_remote():
    ssh = connect_ssh()
    try:
        local_script = Path(__file__).parent / "inspect_aa_j_31.py"
        ...
        remote_file = f"{APP_DIR}/inspect_aa_j_31_remote.py"
        ...
        print("Done. Output written to scripts/inspect_output.txt")
