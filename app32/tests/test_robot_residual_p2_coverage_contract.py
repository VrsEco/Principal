...
P2_RESIDUAL_ROUTE_CONTRACTS = [
    ...
    ('app32/api/routes/internal_audit.py', '/internal-audit/executions', {'GET'}),
    ('app32/api/routes/internal_audit.py', '/internal-audit/executions/<int:execution_id>', {'GET'}),
    ('app32/api/routes/internal_audit.py', '/internal-audit/findings', {'GET'}),
    ('app32/api/routes/internal_audit.py', '/internal-audit/findings/<int:finding_id>', {'GET'}),
    ('app32/api/routes/internal_audit.py', '/internal-audit/follow-ups', {'GET'}),
    ('app32/api/routes/internal_audit.py', '/internal-audit/points', {'GET'}),
    ('app32/api/routes/internal_audit.py', '/internal-audit/reports', {'GET'}),
    ('app32/api/routes/internal_audit.py', '/internal-audit/reports/<int:report_id>/print', {'GET'}),
    ('app32/api/routes/internal_audit.py', '/internal-audit/workpapers', {'GET'}),
