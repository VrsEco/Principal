...
SUITE_CATALOG: dict[str, E2ESuiteDefinition] = {
    ...
    "full_coverage_autocorrect_audit": E2ESuiteDefinition(
        suite_id="full_coverage_autocorrect_audit",
        label="Cobertura total + correções AA.J.1",
        domain="governance",
        environments=("DEV_FULL",),
        command_kind="python",
        command_args=("app32/tests/e2e/scripts/run_full_coverage_autocorrect_audit.py",),
        destructive=False,
        summary="Audita rotas, telas, campos, operações e tools; gera matriz de cobertura e cria log/cards de correção em AA.J.1.",
    ),
    ...
    "contracts_tenant_contract_probe": E2ESuiteDefinition(
        suite_id="contracts_tenant_contract_probe",
        label="Contrato tenant-safe contracts",
        domain="contracts",
        environments=("DEV_FULL",),
        command_kind="pytest",
        command_args=("app32/tests/test_robot_contracts_p1_coverage_contract.py", "-q"),
        destructive=False,
        summary="Valida rotas, templates e controles human-gate de contratos com escopo tenant-safe e sem mutação persistente.",
    ),
    "workspace_tenant_contract_probe": E2ESuiteDefinition(
        suite_id="workspace_tenant_contract_probe",
        label="Contrato tenant-safe workspace",
        domain="workspace",
        environments=("DEV_FULL",),
        command_kind="pytest",
        command_args=("app32/tests/test_robot_workspace_human_gate_contract.py", "-q"),
        destructive=False,
        summary="Valida /main e o contrato estrutural do botão de exclusão do workspace sem executar exclusão cega.",
    ),
    "consultive_tenant_contract_probe": E2ESuiteDefinition(
        suite_id="consultive_tenant_contract_probe",
        label="Contrato tenant-safe consultive",
        domain="consultive",
        environments=("DEV_FULL",),
        command_kind="pytest",
        command_args=("app32/tests/test_urgent_business_review_tenant_contracts.py", "-q"),
        destructive=False,
