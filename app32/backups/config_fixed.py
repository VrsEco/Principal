...
# Force loading .env from the current file's directory
...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = (
        _env_database_url
        or f"postgresql://app:{_default_password}@localhost:5432/bdversusv2"
    )
...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = (
        _dev_database_url
        or f"postgresql://app:{_dev_password}@localhost:5432/bdversusv2"
    )
...
class ProductionConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = (
        _prod_database_url or f"postgresql://app:{quote_plus('*Paraiso1978')}@localhost:5432/bdversusv2"
    )
...
class TestingConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = "postgresql://app:password@localhost:5432/bd_app_versus_test"
