...
class WorkflowGapCandidate(db.Model):
    ...
    app_project_id = db.Column(db.Integer, db.ForeignKey("projects.id", ondelete="SET NULL"), nullable=True)
    app_task_id = db.Column(db.Integer, db.ForeignKey("project_tasks.id", ondelete="SET NULL"), nullable=True)
