...
class ActivityWorkLog(db.Model):
    ...
    activity_type = db.Column(db.String(30), nullable=False)  # 'project', 'process' ou 'process_instance'
    ...
    def to_dict(self):
        ...
        return {
            ...
            "work_date": self.work_date.isoformat() if hasattr(self.work_date, 'isoformat') else self.work_date,
