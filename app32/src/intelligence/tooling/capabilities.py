...
_PRESET_CAPABILITIES: dict[str, dict[str, Any]] = {
    ...
    "list_financial_reconciliation_playbooks": {
        "domain": "finance",
        "scopes": (ToolScope.SAPIENS.value, ToolScope.MCP_ADMIN.value, ToolScope.MCP_ANALYTICS.value),
        "risk": ToolRiskLevel.LOW,
        "permissions": ("financial.view",),
        "tags": ("finance", "read", "tenant_safe", "playbook"),
        "required_context": (TOOL_CONTEXT_COMPANY,),
    },
    "suggest_financial_reconciliation_playbook": {
        "domain": "finance",
        "scopes": (ToolScope.SAPIENS.value, ToolScope.MCP_ADMIN.value, ToolScope.MCP_ANALYTICS.value),
        "risk": ToolRiskLevel.LOW,
        "permissions": ("financial.view",),
        "tags": ("finance", "read", "tenant_safe", "playbook", "suggestion"),
        "required_context": (TOOL_CONTEXT_COMPANY,),
    },
    "create_financial_reconciliation_playbook": {
        "domain": "finance",
        "scopes": (ToolScope.SAPIENS.value, ToolScope.MCP_ADMIN.value),
        "risk": ToolRiskLevel.MEDIUM,
        "permissions": ("financial.create",),
        "human_gate": True,
        "human_gate_reason": "Criação de padrão financeiro exige confirmação explícita e trilha auditável.",
        "tags": ("finance", "mutation", "tenant_safe", "playbook", "explicit_human_confirmation"),
        "required_context": (TOOL_CONTEXT_USER, TOOL_CONTEXT_COMPANY),
    },
    "update_financial_reconciliation_playbook": {
        "domain": "finance",
        "scopes": (ToolScope.SAPIENS.value, ToolScope.MCP_ADMIN.value),
        "risk": ToolRiskLevel.MEDIUM,
        "permissions": ("financial.edit",),
        "human_gate": True,
        "human_gate_reason": "Alteração de padrão financeiro exige confirmação explícita e trilha auditável.",
        "tags": ("finance", "mutation", "tenant_safe", "playbook", "explicit_human_confirmation"),
        "required_context": (TOOL_CONTEXT_USER, TOOL_CONTEXT_COMPANY),
    },
    # Leitura explicitamente publicada na coorte OAuth analytics.
