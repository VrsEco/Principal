    ...
    return DomainPlaybooksManifest(
        playbooks=[
            ...
            DomainPlaybook(
                ...
                discovery_sequence=["describe_app32_profile_contracts_tool", "list_finance_app32_capabilities", "validar permissão financeira efetiva, risco e gate humano quando exigido"],
                prompt_policy=_prompt_policy(
