    ...
    return MCPProfileContractsManifest(
        role_overlays=[
            ...
            MCPRoleOverlayContract(
                ...
                allowed_domains=["routine", "projects", "processes", "meetings", "strategy", "consultive", "identity_self_service"],
            ...
            MCPRoleOverlayContract(
                ...
                allowed_domains=["strategy", "consultive", "projects", "meetings", "identity_self_service"],
