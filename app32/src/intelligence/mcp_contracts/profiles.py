    ...
    return MCPProfileContractsManifest(
        profiles=[
            MCPProfileContract(
                ...
                forbidden_domains=["finance", "governance", "admin", "analytics", "operations"],
            ...
            MCPProfileContract(
                ...
                allowed_domains=["routine", "projects", "meetings", "finance", "strategy", "governance", "analytics"],
            ...
            MCPProfileContract(
                ...
                default_surface="ops",
                allowed_domains=["routine", "projects", "meetings", "finance", "strategy", "governance", "analytics", "operations"],
                forbidden_domains=[],
                max_risk_without_human_gate="medium",
                can_execute_mutations=True,
                can_execute_financial_mutations=True,
