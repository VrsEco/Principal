        ...
        overlay_matrices=[
            ...
            OverlayPermissionSurfaceMatrix(
                ...
                domains=[
                    ...
                    _rule("strategy", ["discover", "read", "create", "analyze", "review"], denied=["update", "delete", "audit"], human_gate_for_actions=["create"], notes=["Criação estratégica somente por capability transacional explícita e human-gated; sem update/delete genérico."]),
        ...
        matrices=[
            ...
            ProfilePermissionSurfaceMatrix(
                ...
                domains=[
                    ...
                    _rule("consultive", ["discover", "read", "analyze", "review"], denied=["create", "update", "delete", "audit"], max_risk_without_human_gate="low", human_gate_for_actions=["review"], notes=["Cliente pode ler roteiros, contexto, evidências e gaps consultivos via MCP, sem registrar decisão ou mutar objetos."]),
            ...
            ProfilePermissionSurfaceMatrix(
                ...
                domains=[
                    ...
                    _rule("consultive", ["discover", "read", "create", "update", "analyze", "audit", "review"], denied=["delete"], human_gate_for_actions=["create", "update", "review"], requires_explicit_company_id=True, notes=["Governança consultiva completa sem exclusão direta; conversões dependem de ferramenta operacional específica."]),
