...
class GeradorRelatoriosProfissionais:
    ...
    def gerar_relatorio_projetos(self, empresa_id):
        ...
        metricas_data = [
            [
                Paragraph('<br/>'.join([
                    '<font size="20" color="#1a76ff"><b>' + str(metricas['total_projetos']) + '</b></font>',
        ...
        metricas_table = Table(metricas_data, colWidths=[6*cm, 6*cm, 6*cm, 6*cm])
        ...
        if projetos:
            ...
            for projeto in projetos:
                tabela_data.append([
                    projeto['codigo'],
                    projeto['nome'][:40] + '...' if len(projeto['nome']) > 40 else projeto['nome'],
                    projeto['status'],
