        ...
        'meetings': [
            {
                ...
                'participants': ['Maria Silva', 'João Santos', 'Ana Costa', 'Pedro Lima', 'Lucia Ferreira']
            },
            {
                ...
                'participants': ['João Santos', 'Ana Costa', 'Carlos Oliveira', 'Roberto Mendes', 'Lucia Ferreira', 'Maria Silva']
            },
            {
                ...
                'participants': ['Ana Costa', 'Maria Silva', 'João Santos', 'Pedro Lima', 'Carlos Oliveira']
            }
        ]
    }
