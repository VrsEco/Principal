...
Data: {{ date }} | Sistema PEVAPP22''',
    ...
    return {
        'model_7_id': model_7_id,
        'model_8_id': model_8_id
    }
...
def create_report_templates(page_config_ids):
    ...
    print(f"✅ Template de Reuniões Resumido criado com ID: {meetings_summary_template_id}")
...
def test_report_generation(template_ids):
    ...
    result = generator.generate_report_from_template(
        template_ids['meetings_template_id'], 
        test_data
    )
    ...
    result_summary = generator.generate_report_from_template(
        template_ids['meetings_summary_template_id'], 
        test_data
    )
...
def main():
    ...
    try:
        ...
        print(f"   - Template Reuniões Completo: ID {template_ids['meetings_template_id']}")
        print(f"   - Template Reuniões Resumido: ID {template_ids['meetings_summary_template_id']}")
